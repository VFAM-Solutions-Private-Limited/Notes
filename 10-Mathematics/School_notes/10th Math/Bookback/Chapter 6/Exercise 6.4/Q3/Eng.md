...
1. Let the height of the cloud above the ground be $H$ m.
2. Let the observer be at a height $h$ m above the lake.
3. Let the horizontal distance between the observer and the cloud be $x$ m.
4. Apply $\tan\theta_1$ to the cloud.
5. Apply $\tan\theta_2$ to the reflection of the cloud.
6. Eliminate $x$ and obtain the required result.
