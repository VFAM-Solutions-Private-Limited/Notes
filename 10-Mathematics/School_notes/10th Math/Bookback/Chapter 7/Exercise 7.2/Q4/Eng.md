...
1. Find the volume of the conical container.
2. Use the given discharge rate of petrol.
3. Calculate the time taken to empty the container.
4. Round off the answer to the nearest minute.
...
Time taken to empty the container,
...
$$
\boxed{\text{Time taken to empty the container}=63 \text{ minutes}}
$$
