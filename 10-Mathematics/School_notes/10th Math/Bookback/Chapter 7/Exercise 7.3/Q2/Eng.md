...
1. Find the radius of the model.
2. Find the length of the cylindrical portion.
3. Calculate the volume of the cylinder.
4. Calculate the volume of the two cones.
5. Add the volumes to find the total volume of the model.
...
&= 1.5 \text{ cm}
\\
\text{Total length of the model}
&= 12 \text{ cm}
\\
\text{Height of each cone}
&= 2 \text{ cm}
\end{aligned}
$$
...
$$
\boxed{\text{Volume of the model}=66 \text{ cm}^3}
$$
