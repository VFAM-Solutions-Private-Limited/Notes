...
1. Find the volume of the aluminium sphere.
2. Find the volume of the cylinder.
3. Equate the two volumes since the sphere is melted to form the cylinder.
...
&= 12 \text{ cm}
\\
\text{Radius of the cylinder }(r)
&= 8 \text{ cm}
\end{aligned}
$$

Since the sphere is melted and recast into a cylinder,
...
$$
\boxed{\text{Height of the cylinder}=36 \text{ cm}}
$$
