...
1. Find the cross-sectional area of the pipe.
2. Calculate the volume of water flowing through the pipe in one hour.
3. Find the volume of water required to raise the water level in the tank by 21 cm.
4. Equate the volumes.
...
$$
\begin{aligned}
\text{Diameter of the pipe}
&= 14 \text{ cm}
\\
\text{Radius of the pipe }(r)
&= 7 \text{ cm}
\\
\text{Speed of water}
&= 15 \text{ km/hr}
...
Volume of water required to raise the water level by 21 cm,
...
$$
\boxed{\text{Time required}=2 \text{ hours}}
$$
